<template>
  <div>
    ...
    <!-- 租借的相关信息 -->
    <div class="info">
      <span class="in" style="color: red">租借中: {{ onloan }}</span>
      <router-link :to="`/return`" class="in"
        >待归还: {{ tobereturned }}</router-link
      >
      <router-link :to="`/poststation`" class="in"
        >驿站中: {{ inthepoststation }}</router-link
      >
      <router-link :to="`/warehouse`" class="in"
        >仓库中: {{ inthewarehouse }}</router-link
      >
  ...
  data() {
    return {
      ...
      searchList: [
        {
          name: "奥德赛", //商品名
          totalleaseterm: "39", //总租借期
          remainingleaseterm: "3", //剩余租借期
          deposit: 100, //押金
          depositDay: "1", //押金/天
          commoditynumber: "SDRF006", //商品号
          ordernumber: "abda99", //订单号
          orderamount: 30, //订单金额
          buyerId: "minus", //买家Id,
          paymenttime: "2020/12/23", //付款时间
        },
        {
          name: "塞尔达传奇", //商品名
          totalleaseterm: "30", //总租借期
          remainingleaseterm: "3", //剩余租借期
          deposit: 100, //押金
          depositDay: "1", //押金/天
