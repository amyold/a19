  ...
  <el-container>
    <el-header>
      <div class="name">
        ...
        <div style="cursor: pointer" @click="showingDetail = false">
          分类管理
        </div>
        <span id="activeCategory" v-if="showingDetail"
          >/{{ activeCategory }}</span
        >
      </div>
    </el-header>
    ...
    <el-main>
      ...
      <el-table v-if="!showingDetail" :data="filteredCategoryList">
        ...
        <el-table-column label="操作" min-width="100" key="4" align="center">
          <template slot-scope="scope">
            <el-button
              @click="viewDetail(scope.row.name)"
              type="text"
              size="small"
              round
              style="
      ...
      <category-detail-navbar
        v-if="showingDetail"
        v-model="showingStatus"
        :counts="[2, 1, 1, 4, 0]"
      ></category-detail-navbar>

      <el-table
        v-if="showingDetail && showingStatus === 0"
      ...
      <el-table
        v-if="showingDetail && showingStatus === 1"
        :data="filteredItemList"
      >
        <el-table-column
          key="17"
        ...
        <el-table-column key="23" label="操作" min-width="150" align="center">
          <template>
            <el-row>
              <el-button
                style="color: #ffffff; background-color: #957bf1"
                round
                size="small"
                >查看详情</el-button
              >
              <el-button
                style="color: #ffffff; background-color: #fcc41b"
                round
                size="small"
                >一键提醒</el-button
              >
      ...
      <el-table
        v-if="showingDetail && showingStatus === 2"
        :data="filteredItemList"
      >
        <el-table-column
          key="24"
        ...
        <el-table-column
          key="27"
          label="驿站地址"
          prop="hostStationAddr"
          align="center"
        ></el-table-column>
        <el-table-column
          key="28"
          label="驿站联系人"
          prop="hostStationContact"
          align="center"
        ></el-table-column>
        <el-table-column key="29" label="操作" align="center" min-width="200">
          <template>
            <el-row>
              ...
              >
              <el-button
                style="color: #ffffff; background-color: #f56c6c"
                round
                size="small"
                >召回</el-button
              >
              <el-button
                style="color: #ffffff; background-color: #16c2c2"
                round
                size="small"
                >发货</el-button
              >
      ...
      <el-table
        v-if="showingDetail && showingStatus === 3"
        :data="filteredItemList"
      >
        <el-table-column
          key="30"
      ...
      <el-table
        v-if="showingDetail && showingStatus === 4"
        :data="filteredItemList"
      >
        <el-table-column
          label="订单编号"
      ...
      <el-pagination
        ...
        :page-size="10"
        :total="total"
        style="padding: 20px 0 0 1100px; text-align: center"
