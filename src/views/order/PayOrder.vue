  ...
  <div>
    <div class="name">
      ...
      <el-breadcrumb separator="/" class="title">
        <el-breadcrumb-item :to="{ path: '/OrderList' }" class="one"
      ...
      <div class="content">
        ...
        <div class="right">
          <el-button type="primary" class="btn" @click="dialogVisible = true"
            >点击发货</el-button
          >
          <el-button type="primary" class="btn" @click="edit = true"
            >修改收货人信息</el-button
          >
    ...
    >
        ...
        <template slot-scope="scope">
          <el-row>
            <img
              ...
              src="@assets/commodity3/sell.png"
              alt="价格"
            />
          ...
          <el-row>
            <img
              style="height: 1em; width: 1em"
              src="@assets/commodity3/rent.png"
              alt="租金"
            />
      ...
      <el-table-column prop="type" label="租/买"> </el-table-column>
      <el-table-column prop="daynumber" label="天数"> </el-table-column>
      ...
      <el-table-column label="小计">
        <template slot-scope="scope">
          {{
            scope.row.type == "租"
              ? scope.row.rentPrice * scope.row.daynumber * scope.row.amount
    ...
    <div class="heading">
      ...
      <el-button type="primary" class="btn" @click="remark = true"
        >备注订单</el-button
      >
    </div>
      ...
      <span class="cin">
        <el-form ref="note" :model="note" label-width="80px">
          <el-form-item label="运单号">
            <el-input v-model="note.number"></el-input>
          </el-form-item>
        </el-form>
      </span>
    ...
    >
      <span class="cin">
        <el-form ref="Information" :model="Information" label-width="120px">
