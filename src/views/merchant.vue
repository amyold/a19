            ...
            <el-dialog
                ...
                <el-form :model="formObject"  ref="ruleForm" label-width="100px" class="demo-ruleForm">
                    <el-form-item label="商家名" prop="name">
                        <el-input v-model="formObject.merchantName"></el-input>
                    </el-form-item>
                    <el-form-item label="商家简介" prop="merchantDesc">
                        <el-input v-model="formObject.merchantDesc" ></el-input>
                    </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            async getList(index)
            {
                ...
                await this.$api.Merchant.getHmsMerchantPageListUsingPOST(this.page).then(res=>
                {
                    var data=res.data
            ...
            async handlePutConfirm()
            {
                ...
                if(this.formType===0)
                {
                    await this.$api.Merchant.addHmsMerchantUsingPUT(this.formObject).then(res=>{
                        var code = res.code;
                        if(code===200)
                        {
                            this.closeForm();
                ...
                {
                    await this.$api.Merchant.updateHmsMerchantUsingPOST(this.formObject).then(res=>{
                        var code = res.code;
                        if(code===200)
                        {
                            this.closeForm();
